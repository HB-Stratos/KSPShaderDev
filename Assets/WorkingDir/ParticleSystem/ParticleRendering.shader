Shader "Hidden/ParticleRendering"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            StructuredBuffer<float3> _ParticleVertexPositions;
            int _IsBillboard;
            ...
            {
                //get vertex position
                int positionIndex = _ParticleTriangles[vertex_id];
                float3 position = _ParticleVertexPositions[positionIndex];
                //add sphere position
                position += _ParticlePositions[instance_id];
